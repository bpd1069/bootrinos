...
read BOOTRINOJSON <<"BOOTRINOJSONMARKER"
{
  ...
  "options": "",
  "logoURL": "",
  "readmeURL": "https://raw.githubusercontent.com/bootrino/bootrinos/master/tinycore_install_webserver_mirageos_linux/README.md",
...
download_files()
{
    ...
    URL_BASE=https://raw.githubusercontent.com/bootrino/bootrinos/master/tinycore_install_webserver_mirageos_linux/
